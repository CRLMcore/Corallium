...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000403fd351afdbcfabce703772b185a5ef7d29f3fc1744c137e41609a62e2"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1586058608, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
         ...
         */
        const char* pszTimestamp = "April 14 start of 'massive testing' of persons suspected of coronavirus infection.";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1586058608;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 384990;
       // MineGenesis(genesis);
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000403fd351afdbcfabce703772b185a5ef7d29f3fc1744c137e41609a62e2"));
        assert(genesis.hashMerkleRoot == uint256("0x194f37ce0aad32ed2125c1ee6a0f41a6aad9a7143906b67428761382881288a8"));
        
        // DNS Seeding
        vSeeds.push_back(CDNSSeedData("104.248.117.22", "77.55.218.199"));
